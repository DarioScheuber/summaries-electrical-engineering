...
## Joystick
So gibt es zb die `.stick.get_events()` Methode, welche eine Liste von vorgekommenen Joystick Bewegungen zurückgibt.
`event = ( 'timestamp', 'direction', 'action')`
timestamp: Zeitpunkt des Events
direction: Richtung, in welche der Joystick gedrückt wurde
action: Aktion (pressed, held, released)
